...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'P3Profile.country'
        db.add_column('p3_p3profile', 'country', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'P3Profile.country'
        db.delete_column('p3_p3profile', 'country')
    ...
    models = {
        ...
        'p3.p3profile': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '3', 'blank': 'True'}),
