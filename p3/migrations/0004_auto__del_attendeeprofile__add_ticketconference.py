...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('p3_attendeeprofile', 'p3_ticketconference')

    def backwards(self, orm):

        db.rename_table('p3_ticketconference', 'p3_attendeeprofile')
    ...
    models = {
        ...
        'p3.ticketconference': {
            ...
            'attendee': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'p3_conference'", 'unique': 'True', 'to': "orm['conference.Ticket']"}),
