...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'p3_hotelroom', 'booking',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['p3.HotelBooking'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HotelRoom.booking'
        db.delete_column(u'p3_hotelroom', 'booking_id')
