...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'P3Profile.id'
        db.delete_column('p3_p3profile', 'id')

        # Changing field 'P3Profile.profile'
        db.alter_column('p3_p3profile', 'profile_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['conference.AttendeeProfile']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'P3Profile.id'
        raise RuntimeError("Cannot reverse this migration. 'P3Profile.id' and its values cannot be restored.")

        # Changing field 'P3Profile.profile'
        db.alter_column('p3_p3profile', 'profile_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['conference.AttendeeProfile']))
