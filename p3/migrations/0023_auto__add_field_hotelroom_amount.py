...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HotelRoom.amount'
        db.add_column('p3_hotelroom', 'amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HotelRoom.amount'
        db.delete_column('p3_hotelroom', 'amount')
