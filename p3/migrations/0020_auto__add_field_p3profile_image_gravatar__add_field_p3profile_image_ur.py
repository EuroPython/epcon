...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'P3Profile.image_gravatar'
        db.add_column('p3_p3profile', 'image_gravatar', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'P3Profile.image_url'
        db.add_column('p3_p3profile', 'image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'P3Profile.image_gravatar'
        db.delete_column('p3_p3profile', 'image_gravatar')

        # Deleting field 'P3Profile.image_url'
        db.delete_column('p3_p3profile', 'image_url')
