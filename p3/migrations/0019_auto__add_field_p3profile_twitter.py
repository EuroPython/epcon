...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'P3Profile.twitter'
        db.add_column('p3_p3profile', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'P3Profile.twitter'
        db.delete_column('p3_p3profile', 'twitter')
