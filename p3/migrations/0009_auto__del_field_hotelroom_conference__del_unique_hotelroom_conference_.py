...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HotelRoom.conference'
        db.delete_column(u'p3_hotelroom', 'conference_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'HotelRoom.conference'
        raise RuntimeError("Cannot reverse this migration. 'HotelRoom.conference' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'HotelRoom.conference'
        db.add_column(u'p3_hotelroom', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Conference']),
                      keep_default=False)
    ...
    models = {
        ...
        u'p3.hotelroom': {
            ...
            'booking': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['p3.HotelBooking']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
