...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('p3', ['TicketRoom'])

        # Adding model 'HotelRoom'
        db.create_table('p3_hotelroom', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conference', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Conference'])),
            ('room_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('p3', ['HotelRoom'])

        # Adding unique constraint on 'HotelRoom', fields ['conference', 'room_type']
        db.create_unique('p3_hotelroom', ['conference_id', 'room_type'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'HotelRoom', fields ['conference', 'room_type']
        db.delete_unique('p3_hotelroom', ['conference_id', 'room_type'])

        # Deleting model 'TicketRoom'
        db.delete_table('p3_ticketroom')

        # Deleting model 'HotelRoom'
        db.delete_table('p3_hotelroom')
    ...
    models = {
        ...
        'p3.hotelroom': {
            ...
            'room_type': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        'p3.p3profile': {
