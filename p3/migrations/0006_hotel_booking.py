...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        r = orm.HotelBooking()
        r.conference_id = 'ep2012'
        r.booking_start = datetime.datetime(2012, 6, 30)
        r.booking_end = datetime.datetime(2012, 7, 10)
        r.default_start = datetime.datetime(2012, 7, 2)
        r.default_end = datetime.datetime(2012, 7, 8)
        r.minimum_night = 3
        r.save()

        r = orm.HotelBooking()
        r.conference_id = 'ep2013'
        r.booking_start = datetime.datetime(2013, 6, 28)
        r.booking_end = datetime.datetime(2013, 7, 9)
        r.default_start = datetime.datetime(2013, 7, 2)
        r.default_end = datetime.datetime(2013, 7, 6)
        r.minimum_night = 3
        r.save()

        r = orm.HotelBooking()
        r.conference_id = 'pycon6'
        r.booking_start = datetime.datetime(2015, 4, 15)
        r.booking_end = datetime.datetime(2015, 4, 21)
        r.default_start = datetime.datetime(2015, 4, 17)
        r.default_end = datetime.datetime(2015, 4, 20)
        r.minimum_night = 1
        r.save()
