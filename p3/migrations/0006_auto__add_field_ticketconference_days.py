...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TicketConference.days'
        db.add_column('p3_ticketconference', 'days', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TicketConference.days'
        db.delete_column('p3_ticketconference', 'days')
    ...
    models = {
        ...
        'p3.ticketconference': {
            ...
            'days': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
