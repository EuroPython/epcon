...
RECAPTCHA_PRIVATE_KEY = config('RECAPTCHA_PRIVATE_KEY', default='no-private-key-set')
# Key registered for EuroPython domains
RECAPTCHA_PUBLIC_KEY = config(
    'RECAPTCHA_PUBLIC_KEY', default='6LdFmQcTAAAAAN1xx4M5UN6yg4TwFRXUwIrH5iGh')
