...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'P3Profile.country'
        db.alter_column('p3_p3profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'P3Profile.country'
        db.alter_column('p3_p3profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=3))
