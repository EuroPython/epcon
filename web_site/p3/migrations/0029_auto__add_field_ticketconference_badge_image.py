...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TicketConference.badge_image'
        db.add_column('p3_ticketconference', 'badge_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TicketConference.badge_image'
        db.delete_column('p3_ticketconference', 'badge_image')
