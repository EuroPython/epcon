...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketConference.days'
        db.alter_column('p3_ticketconference', 'days', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'TicketConference.days'
        db.alter_column('p3_ticketconference', 'days', self.gf('django.db.models.fields.CharField')(max_length=15))
