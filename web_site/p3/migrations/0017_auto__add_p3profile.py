...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('p3_p3profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='p3_profile', unique=True, to=orm['conference.AttendeeProfile'])),
        ))
        db.send_create_signal('p3', ['P3Profile'])


    def backwards(self, orm):
        
        # Deleting model 'P3Profile'
        db.delete_table('p3_p3profile')
    ...
    models = {
        ...
        'p3.p3profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'p3_profile'", 'unique': 'True', 'to': "orm['conference.AttendeeProfile']"})
        },
