...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'P3Profile.tagline'
        db.add_column('p3_p3profile', 'tagline', self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'P3Profile.tagline'
        db.delete_column('p3_p3profile', 'tagline')
