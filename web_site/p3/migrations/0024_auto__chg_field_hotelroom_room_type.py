...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HotelRoom.room_type'
        db.alter_column('p3_hotelroom', 'room_type', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'HotelRoom.room_type'
        db.alter_column('p3_hotelroom', 'room_type', self.gf('django.db.models.fields.CharField')(max_length=1))
