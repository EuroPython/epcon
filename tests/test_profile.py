...
@pytest.mark.xfail
def test_profile_page_available_during_voting_with_proposal():
    assert False


@pytest.mark.xfail
def test_profile_page_available_if_public():
    assert False


@pytest.mark.xfail
def test_profile_page_available_if_participant_only_and_authenticated():
    assert False


@pytest.mark.xfail
def test_profile_page_available_if_has_accepted_talks():
    assert False


@pytest.mark.xfail
def test_profile_page_unavailable_template():
    assert False
