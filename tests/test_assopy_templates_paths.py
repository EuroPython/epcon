...
def test_assopy_invoice(client):
    ...
    _template_paths = template_paths(response)

    assert "/templates/assopy/base_invoice.html" in _template_paths
    assert "/assopy/templates/assopy/base_invoice.html" not in _template_paths
    assert "/p3/templates/assopy/base_invoice.html" not in _template_paths

    assert "/templates/assopy/invoice.html" in _template_paths
    assert "/assopy/templates/assopy/invoice.html" not in _template_paths
    assert "/p3/templates/assopy/invoice.html" not in _template_paths
