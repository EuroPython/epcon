...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'OrderItem', fields ['ticket']
        db.create_unique('assopy_orderitem', ['ticket_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OrderItem', fields ['ticket']
        db.delete_unique('assopy_orderitem', ['ticket_id'])

        # Changing field 'OrderItem.ticket'
        db.alter_column('assopy_orderitem', 'ticket_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Ticket']))
