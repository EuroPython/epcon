...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RefundCreditNote'
        db.create_table('assopy_refundcreditnote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('credit_note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.CreditNote'])),
            ('refund', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.Refund'])),
        ))
        db.send_create_signal('assopy', ['RefundCreditNote'])


    def backwards(self, orm):
        
        # Deleting model 'RefundCreditNote'
        db.delete_table('assopy_refundcreditnote')
    ...
    models = {
        ...
        'assopy.refundcreditnote': {
            ...
            'credit_note': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assopy.CreditNote']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
