...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('assopy_country', 'id')

        # Changing field 'Country.iso'
        db.alter_column('assopy_country', 'iso', self.gf('django.db.models.fields.CharField')(max_length=2, primary_key=True))

        # Adding unique constraint on 'Country', fields ['iso']
        db.create_unique('assopy_country', ['iso'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Country', fields ['iso']
        db.delete_unique('assopy_country', ['iso'])

        # We cannot add back in field 'Country.id'
        raise RuntimeError(
            "Cannot reverse this migration. 'Country.id' and its values cannot be restored.")

        # Changing field 'Country.iso'
        db.alter_column('assopy_country', 'iso', self.gf('django.db.models.fields.CharField')(max_length=2))
