...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.conference'
        db.add_column('assopy_coupon', 'conference', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['conference.Conference']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.conference'
        db.delete_column('assopy_coupon', 'conference_id')
