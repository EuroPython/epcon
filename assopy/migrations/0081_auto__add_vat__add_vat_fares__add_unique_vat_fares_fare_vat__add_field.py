...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assopy_orderitem', 'vat', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['assopy.Vat'], null=True), keep_default=False)

        # Adding field 'Invoice.vat'
        db.add_column('assopy_invoice', 'vat', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['assopy.Vat'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Invoice.code'
        db.alter_column('assopy_invoice', 'code', self.gf('django.db.models.fields.CharField')(default=None, max_length=9, unique=True))
    ...
    models = {
        ...
        'assopy.invoice': {
            ...
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
            'vat': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assopy.Vat']", 'null': 'True'})
        },
        'assopy.order': {
