...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.card_name'
        db.add_column('assopy_user', 'card_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'User.account_type'
        db.add_column('assopy_user', 'account_type', self.gf('django.db.models.fields.CharField')(default='p', max_length=1), keep_default=False)

        # Adding field 'User.vat_number'
        db.add_column('assopy_user', 'vat_number', self.gf('django.db.models.fields.CharField')(default='', max_length=22, blank=True), keep_default=False)

        # Adding field 'User.cf_number'
        db.add_column('assopy_user', 'cf_number', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True), keep_default=False)

        # Adding field 'User.country'
        db.add_column('assopy_user', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.Country'], null=True, blank=True), keep_default=False)

        # Adding field 'User.zip_code'
        db.add_column('assopy_user', 'zip_code', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)

        # Adding field 'User.address'
        db.add_column('assopy_user', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'User.city'
        db.add_column('assopy_user', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'User.provincia'
        db.add_column('assopy_user', 'provincia', self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.card_name'
        db.delete_column('assopy_user', 'card_name')

        # Deleting field 'User.account_type'
        db.delete_column('assopy_user', 'account_type')

        # Deleting field 'User.vat_number'
        db.delete_column('assopy_user', 'vat_number')

        # Deleting field 'User.cf_number'
        db.delete_column('assopy_user', 'cf_number')

        # Deleting field 'User.country'
        db.delete_column('assopy_user', 'country_id')

        # Deleting field 'User.zip_code'
        db.delete_column('assopy_user', 'zip_code')

        # Deleting field 'User.address'
        db.delete_column('assopy_user', 'address')

        # Deleting field 'User.city'
        db.delete_column('assopy_user', 'city')

        # Deleting field 'User.provincia'
        db.delete_column('assopy_user', 'provincia')
