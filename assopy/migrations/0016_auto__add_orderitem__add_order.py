...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assopy_orderitem', (
        ...
        db.send_create_signal('assopy', ['OrderItem'])

        # Adding model 'Order'
        db.create_table('assopy_order', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True)),
            ('assopy_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=22, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('assopy', ['Order'])


    def backwards(self, orm):
        
        # Deleting model 'OrderItem'
        db.delete_table('assopy_orderitem')

        # Deleting model 'Order'
        db.delete_table('assopy_order')
