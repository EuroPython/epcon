...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvoiceLog.code'
        db.alter_column('assopy_invoicelog', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

        # Changing field 'CreditNote.code'
        db.alter_column('assopy_creditnote', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

        # Changing field 'Invoice.code'
        db.alter_column('assopy_invoice', 'code', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True))

        # Changing field 'Order.code'
        db.alter_column('assopy_order', 'code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'InvoiceLog.code'
        db.alter_column('assopy_invoicelog', 'code', self.gf('django.db.models.fields.CharField')(max_length=9, unique=True))

        # Changing field 'CreditNote.code'
        db.alter_column('assopy_creditnote', 'code', self.gf('django.db.models.fields.CharField')(max_length=9, unique=True))

        # Changing field 'Invoice.code'
        db.alter_column('assopy_invoice', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=9, null=True))

        # Changing field 'Order.code'
        db.alter_column('assopy_order', 'code', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))
