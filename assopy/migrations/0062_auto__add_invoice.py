...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assopy_invoice', (
            ...
            ('assopy_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=22)),
        ...
        db.send_create_signal('assopy', ['Invoice'])


    def backwards(self, orm):
        
        # Deleting model 'Invoice'
        db.delete_table('assopy_invoice')
