...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field items on 'Refund'
        db.create_table('assopy_refund_items', (
        ...
        db.create_unique('assopy_refund_items', ['refund_id', 'orderitem_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field items on 'Refund'
        db.delete_table('assopy_refund_items')
