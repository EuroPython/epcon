...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.assopy_id'
        db.add_column('assopy_user', 'assopy_id', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=22, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.assopy_id'
        db.delete_column('assopy_user', 'assopy_id')
