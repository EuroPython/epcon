...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vat.invoice_notice'
        db.add_column('assopy_vat', 'invoice_notice', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Vat.description'
        db.alter_column('assopy_vat', 'description', self.gf('django.db.models.fields.CharField')(max_length=125, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Vat.invoice_notice'
        db.delete_column('assopy_vat', 'invoice_notice')

        # Changing field 'Vat.description'
        db.alter_column('assopy_vat', 'description', self.gf('django.db.models.fields.TextField')(null=True))
