...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.speaker'
        db.add_column('assopy_user', 'speaker', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['conference.Speaker'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.speaker'
        db.delete_column('assopy_user', 'speaker_id')
    ...
    models = {
        'assopy.user': {
            ...
            'speaker': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['conference.Speaker']", 'unique': 'True', 'null': 'True'}),
