...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'User'
        db.create_table('assopy_user', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('assopy', ['User'])

        # Adding model 'UserIdentity'
        db.create_table('assopy_useridentity', (
        ...
        db.send_create_signal('assopy', ['UserIdentity'])


    def backwards(self, orm):
        
        # Deleting model 'User'
        db.delete_table('assopy_user')

        # Deleting model 'UserIdentity'
        db.delete_table('assopy_useridentity')
