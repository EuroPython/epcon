...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Token.payload'
        db.add_column('assopy_token', 'payload', self.gf('django.db.models.fields.TextField')(default='', blank=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Token.payload'
        db.delete_column('assopy_token', 'payload')
