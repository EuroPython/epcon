...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.deductible'
        db.add_column('assopy_order', 'deductible', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Order.billing_notes'
        db.add_column('assopy_order', 'billing_notes', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.deductible'
        db.delete_column('assopy_order', 'deductible')

        # Deleting field 'Order.billing_notes'
        db.delete_column('assopy_order', 'billing_notes')
    ...
    models = {
        ...
        'assopy.order': {
            ...
            'billing_notes': ('django.db.models.fields.TextField', [], {}),
            ...
            'deductible': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
