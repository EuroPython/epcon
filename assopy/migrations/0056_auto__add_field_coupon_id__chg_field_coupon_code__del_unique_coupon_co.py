...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('assopy_coupon', ['code'])

        # Changing field 'Coupon.code'
        db.alter_column('assopy_coupon', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Adding field 'Coupon.id'
        db.add_column('assopy_coupon', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)



    def backwards(self, orm):
        
        # Deleting field 'Coupon.id'
        db.delete_column('assopy_coupon', 'id')

        # Changing field 'Coupon.code'
        db.alter_column('assopy_coupon', 'code', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True))

        # Adding unique constraint on 'Coupon', fields ['code']
        db.create_unique('assopy_coupon', ['code'])
