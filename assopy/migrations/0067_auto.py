...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tempitem on 'Refund'
        db.create_table('assopy_refund_tempitem', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('refund', models.ForeignKey(orm['assopy.refund'], null=False)),
            ('orderitem', models.ForeignKey(orm['assopy.orderitem'], null=False))
        ))
        db.create_unique('assopy_refund_tempitem', ['refund_id', 'orderitem_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field tempitem on 'Refund'
        db.delete_table('assopy_refund_tempitem')
    ...
    models = {
        ...
        'assopy.refund': {
            ...
            'tempitem': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'temp'", 'symmetrical': 'False', 'to': "orm['assopy.OrderItem']"})
        },
        'assopy.token': {
