...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Refund.orderitem'
        db.delete_column('assopy_refund', 'orderitem_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Refund.orderitem'
        raise RuntimeError("Cannot reverse this migration. 'Refund.orderitem' and its values cannot be restored.")
