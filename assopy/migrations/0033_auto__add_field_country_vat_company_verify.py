...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Country.vat_company_verify'
        db.add_column('assopy_country', 'vat_company_verify', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Country.vat_company_verify'
        db.delete_column('assopy_country', 'vat_company_verify')
