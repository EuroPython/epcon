...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('assopy_order', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.User']))


    def backwards(self, orm):
        
        # Changing field 'Order.user'
        db.alter_column('assopy_order', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
