...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.assopy_id'
        db.alter_column('assopy_user', 'assopy_id', self.gf('django.db.models.fields.CharField')(max_length=22, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'User.assopy_id'
        db.alter_column('assopy_user', 'assopy_id', self.gf('django.db.models.fields.CharField')(max_length=22, unique=True))
