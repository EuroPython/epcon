...
#        ))
#        db.send_create_signal('assopy', ['Vat_fares'])

        # Adding unique constraint on 'Vat_fares', fields ['fare', 'vat']
        db.create_unique('assopy_vat_fares', ['fare_id', 'vat_id'])

        # Changing field 'OrderItem.vat'
        db.alter_column('assopy_orderitem', 'vat_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['assopy.Vat']))

        # Removing M2M table for field fares on 'Vat'
        db.delete_table('assopy_vat_fares')

        # Changing field 'Invoice.vat'
        db.alter_column('assopy_invoice', 'vat_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['assopy.Vat']))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Vat_fares', fields ['fare', 'vat']
        db.delete_unique('assopy_vat_fares', ['fare_id', 'vat_id'])

        # Deleting model 'Vat_fares'
        db.delete_table('assopy_vat_fares')

        # Changing field 'OrderItem.vat'
        db.alter_column('assopy_orderitem', 'vat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.Vat'], null=True))
...
#        ))
        ...
        # Changing field 'Invoice.vat'
        db.alter_column('assopy_invoice', 'vat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.Vat'], null=True))
    ...
    models = {
        ...
        'assopy.vat': {
            ...
            'fares': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['conference.Fare']", 'null': 'True', 'through': "orm['assopy.Vat_fares']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '2', 'decimal_places': '0'})
        },
        'assopy.vat_fares': {
            'Meta': {'unique_together': "(('fare', 'vat'),)", 'object_name': 'Vat_fares'},
