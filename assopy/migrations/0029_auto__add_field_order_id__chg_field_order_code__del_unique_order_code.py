...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('assopy_order', ['code'])

        # Changing field 'Order.code'
        db.alter_column('assopy_order', 'code', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
        # Adding field 'Order.id'
        db.add_column('assopy_order', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('assopy_order', 'id')

        # Changing field 'Order.code'
        db.alter_column('assopy_order', 'code', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True))

        # Adding unique constraint on 'Order', fields ['code']
        db.create_unique('assopy_order', ['code'])
