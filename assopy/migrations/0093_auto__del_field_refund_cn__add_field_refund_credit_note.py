...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('assopy_refund', 'cn_id', 'credit_note_id')

    def backwards(self, orm):
        db.rename_column('assopy_refund', 'credit_note_id', 'cn_id')
    ...
    models = {
        ...
        'assopy.refund': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'credit_note': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'to': "orm['assopy.CreditNote']", 'unique': 'True', 'null': 'True'}),
