...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assopy_order', 'method', self.gf('django.db.models.fields.CharField')(default='bank', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.method'
        db.delete_column('assopy_order', 'method')
