...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'RefundOrderItem', fields ['refund', 'orderitem']
        db.create_unique('assopy_refundorderitem', ['refund_id', 'orderitem_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RefundOrderItem', fields ['refund', 'orderitem']
        db.delete_unique('assopy_refundorderitem', ['refund_id', 'orderitem_id'])
