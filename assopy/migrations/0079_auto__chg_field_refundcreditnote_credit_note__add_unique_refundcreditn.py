...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RefundCreditNote.credit_note'
        db.alter_column('assopy_refundcreditnote', 'credit_note_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['assopy.CreditNote'], unique=True))

        # Adding unique constraint on 'RefundCreditNote', fields ['credit_note']
        db.create_unique('assopy_refundcreditnote', ['credit_note_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RefundCreditNote', fields ['credit_note']
        db.delete_unique('assopy_refundcreditnote', ['credit_note_id'])

        # Changing field 'RefundCreditNote.credit_note'
        db.alter_column('assopy_refundcreditnote', 'credit_note_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.CreditNote']))
