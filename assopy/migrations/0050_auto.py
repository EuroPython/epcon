...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field coupons on 'Order'
        db.delete_table('assopy_order_coupons')


    def backwards(self, orm):
        
        # Adding M2M table for field coupons on 'Order'
        db.create_table('assopy_order_coupons', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['assopy.order'], null=False)),
            ('coupon', models.ForeignKey(orm['assopy.coupon'], null=False))
        ))
        db.create_unique('assopy_order_coupons', ['order_id', 'coupon_id'])
