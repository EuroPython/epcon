...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.payment_url'
        db.add_column('assopy_order', 'payment_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.payment_url'
        db.delete_column('assopy_order', 'payment_url')
