...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.items_per_usage'
        db.add_column('assopy_coupon', 'items_per_usage', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.items_per_usage'
        db.delete_column('assopy_coupon', 'items_per_usage')
    ...
    models = {
        ...
        'assopy.coupon': {
            ...
            'fares': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['conference.Fare']", 'symmetrical': 'False'}),
