...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Refund.invoice'
        db.add_column('assopy_refund', 'invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.Invoice'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Refund.invoice'
        db.delete_column('assopy_refund', 'invoice_id')
