...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assopy_invoice', 'note',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('assopy_invoice', 'note')
    ...
    models = {
        ...
        'assopy.creditnote': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'credit_note'", 'to': "orm['assopy.Invoice']"}),
