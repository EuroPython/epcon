...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Token', fields ['user']
        db.delete_unique('assopy_token', ['user_id'])

        # Changing field 'Token.user'
        db.alter_column('assopy_token', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Token.user'
        db.alter_column('assopy_token', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'Token', fields ['user']
        db.create_unique('assopy_token', ['user_id'])
