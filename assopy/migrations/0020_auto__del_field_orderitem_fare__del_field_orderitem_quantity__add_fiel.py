...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderItem.fare'
        db.delete_column('assopy_orderitem', 'fare_id')

        # Deleting field 'OrderItem.quantity'
        db.delete_column('assopy_orderitem', 'quantity')

        # Adding field 'OrderItem.ticket'
        db.add_column('assopy_orderitem', 'ticket', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['conference.Ticket']), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'OrderItem.fare'
        raise RuntimeError(
            "Cannot reverse this migration. 'OrderItem.fare' and its values cannot be restored.")

        # We cannot add back in field 'OrderItem.quantity'
        raise RuntimeError(
            "Cannot reverse this migration. 'OrderItem.quantity' and its values cannot be restored.")

        # Deleting field 'OrderItem.ticket'
        db.delete_column('assopy_orderitem', 'ticket_id')
