...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Refund.assopy_id'
        db.delete_column('assopy_refund', 'assopy_id')

        # Adding field 'Refund.credit_note'
        db.add_column('assopy_refund', 'credit_note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.CreditNote'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Refund.assopy_id'
        db.add_column('assopy_refund', 'assopy_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=22, null=True, blank=True), keep_default=False)

        # Deleting field 'Refund.credit_note'
        db.delete_column('assopy_refund', 'credit_note_id')
