...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assopy_coupon', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.user'
        db.delete_column('assopy_coupon', 'user_id')
