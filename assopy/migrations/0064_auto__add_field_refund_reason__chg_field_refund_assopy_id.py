...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assopy_refund', 'reason', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Changing field 'Refund.assopy_id'
        db.alter_column('assopy_refund', 'assopy_id', self.gf('django.db.models.fields.CharField')(max_length=22, unique=True, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Refund.reason'
        db.delete_column('assopy_refund', 'reason')

        # Changing field 'Refund.assopy_id'
        db.alter_column('assopy_refund', 'assopy_id', self.gf('django.db.models.fields.CharField')(default='', max_length=22, unique=True))
    ...
    models = {
        ...
        'assopy.refund': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'queue'", 'max_length': '8'})
        },
        'assopy.token': {
