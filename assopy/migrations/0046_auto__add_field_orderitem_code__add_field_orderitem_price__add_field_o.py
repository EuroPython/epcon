...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assopy_orderitem', 'code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)

        # Adding field 'OrderItem.price'
        db.add_column('assopy_orderitem', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2), keep_default=False)

        # Adding field 'OrderItem.description'
        db.add_column('assopy_orderitem', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, default='', blank=True), keep_default=False)

        # Changing field 'OrderItem.ticket'
        db.alter_column('assopy_orderitem', 'ticket_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['conference.Ticket'], unique=True, null=True))


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.code'
        db.delete_column('assopy_orderitem', 'code')

        # Deleting field 'OrderItem.price'
        db.delete_column('assopy_orderitem', 'price')

        # Deleting field 'OrderItem.description'
        db.delete_column('assopy_orderitem', 'description')

        # Changing field 'OrderItem.ticket'
        db.alter_column('assopy_orderitem', 'ticket_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['conference.Ticket'], unique=True))
    ...
    models = {
        ...
        'assopy.order': {
            ...
            'coupons': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['assopy.Coupon']", 'symmetrical': 'False'}),
        ...
        'assopy.orderitem': {
            ...
            'ticket': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['conference.Ticket']", 'unique': 'True', 'null': 'True'})
        },
        'assopy.token': {
