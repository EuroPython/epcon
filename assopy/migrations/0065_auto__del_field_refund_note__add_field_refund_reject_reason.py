...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Refund.note'
        db.delete_column('assopy_refund', 'note')

        # Adding field 'Refund.reject_reason'
        db.add_column('assopy_refund', 'reject_reason', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Refund.note'
        db.add_column('assopy_refund', 'note', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Refund.reject_reason'
        db.delete_column('assopy_refund', 'reject_reason')
