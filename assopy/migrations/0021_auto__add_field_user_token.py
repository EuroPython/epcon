...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assopy_user', 'token', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.token'
        db.delete_column('assopy_user', 'token')
