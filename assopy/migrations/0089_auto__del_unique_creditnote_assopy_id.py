...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CreditNote', fields ['assopy_id']
        db.delete_unique('assopy_creditnote', ['assopy_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'CreditNote', fields ['assopy_id']
        db.create_unique('assopy_creditnote', ['assopy_id'])
