...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('assopy_order', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.Country'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Order.country'
        db.alter_column('assopy_order', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assopy.Country']))
