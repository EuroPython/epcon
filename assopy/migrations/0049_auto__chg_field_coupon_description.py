...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coupon.description'
        db.alter_column('assopy_coupon', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Coupon.description'
        db.alter_column('assopy_coupon', 'description', self.gf('django.db.models.fields.TextField')())
