...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order._complete'
        db.add_column('assopy_order', '_complete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order._complete'
        db.delete_column('assopy_order', '_complete')
