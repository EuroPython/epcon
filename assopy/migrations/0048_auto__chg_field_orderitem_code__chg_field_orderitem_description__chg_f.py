...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderItem.code'
        db.alter_column('assopy_orderitem', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'OrderItem.description'
        db.alter_column('assopy_orderitem', 'description', self.gf('django.db.models.fields.TextField')(max_length=100))

        # Changing field 'OrderItem.price'
        db.alter_column('assopy_orderitem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'OrderItem.code'
        db.alter_column('assopy_orderitem', 'code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'OrderItem.description'
        db.alter_column('assopy_orderitem', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'OrderItem.price'
        db.alter_column('assopy_orderitem', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
