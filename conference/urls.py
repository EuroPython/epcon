...
urlpatterns = patterns('',
    ...
    url(r'^schedule/(?P<conference>.*)/(?P<slug>[\w-]+).xml/speakers.xml$', 'conference.views.schedule_speakers_xml', name = 'conference-schedule-speakers-xml'),
    ...
    url(r'^(?P<conference>[\w-]+)/data.xml$', 'conference.views.conference_data', name = 'conference-data-xml'),
    url(r'^(?P<conference>[\w-]+)/talks.xml$', 'conference.views.talks_xml', name = 'conference-talks-xml'),
