...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.prerequisites'
        db.add_column(u'conference_talk', 'prerequisites',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Talk.prerequisites'
        db.delete_column(u'conference_talk', 'prerequisites')
