...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Talk.abstract_extra'
        db.add_column(u'conference_talk', 'abstract_extra',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Talk.abstract_extra'
        db.delete_column(u'conference_talk', 'abstract_extra')
