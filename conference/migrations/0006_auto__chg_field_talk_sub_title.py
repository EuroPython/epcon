...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Talk.sub_title'
        db.alter_column(u'conference_talk', 'sub_title', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Talk.sub_title'
        db.alter_column(u'conference_talk', 'sub_title', self.gf('django.db.models.fields.CharField')(max_length=100))
