...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.abstract_short'
        db.add_column(u'conference_talk', 'abstract_short',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Talk.abstract_short'
        db.delete_column(u'conference_talk', 'abstract_short')
