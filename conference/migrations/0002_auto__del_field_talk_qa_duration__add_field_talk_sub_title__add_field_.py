...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'conference_talk', 'qa_duration')

        # Adding field 'Talk.sub_title'
        db.add_column(u'conference_talk', 'sub_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Talk.prerequesites'
        db.add_column(u'conference_talk', 'prerequesites',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'Talk.admin_type'
        db.add_column(u'conference_talk', 'admin_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Talk.abstracts_short'
        db.add_column(u'conference_talk', 'abstracts_short',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'Talk.title'
        db.alter_column(u'conference_talk', 'title', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):
        # Adding field 'Talk.qa_duration'
        db.add_column(u'conference_talk', 'qa_duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Talk.sub_title'
        db.delete_column(u'conference_talk', 'sub_title')

        # Deleting field 'Talk.prerequesites'
        db.delete_column(u'conference_talk', 'prerequesites')

        # Deleting field 'Talk.admin_type'
        db.delete_column(u'conference_talk', 'admin_type')

        # Deleting field 'Talk.abstracts_short'
        db.delete_column(u'conference_talk', 'abstracts_short')


        # Changing field 'Talk.title'
        db.alter_column(u'conference_talk', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'conference.talk': {
            ...
            'abstracts_short': ('django.db.models.fields.TextField', [], {'default': "''"}),
            ...
            'prerequesites': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150', 'blank': 'True'}),
            ...
            'sub_title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
