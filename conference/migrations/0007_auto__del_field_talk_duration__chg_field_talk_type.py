...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Talk.type'
        db.alter_column(u'conference_talk', 'type', self.gf('django.db.models.fields.CharField')(max_length=5))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Talk.type'
        db.alter_column(u'conference_talk', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
