...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarkitUpPluginModel'
        db.create_table(u'cms_utils_markituppluginmodel', (
        ...
        db.send_create_signal(u'cms_utils', ['MarkitUpPluginModel'])


    def backwards(self, orm):
        # Deleting model 'MarkitUpPluginModel'
        db.delete_table(u'cms_utils_markituppluginmodel')
