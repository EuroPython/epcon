...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketConference.shirt_size'
        db.alter_column('p3_ticketconference', 'shirt_size', self.gf('django.db.models.fields.CharField')(max_length=3))


    def backwards(self, orm):
        
        # Changing field 'TicketConference.shirt_size'
        db.alter_column('p3_ticketconference', 'shirt_size', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'p3.ticketconference': {
            ...
            'shirt_size': ('django.db.models.fields.CharField', [], {'default': "'l'", 'max_length': '3'}),
