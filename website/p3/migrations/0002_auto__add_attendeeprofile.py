...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('p3_attendeeprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attendee', self.gf('django.db.models.fields.related.OneToOneField')(related_name='p3_conference', unique=True, to=orm['conference.Attendee'])),
            ('shirt_size', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('python_experience', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('diet', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('tagline', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
        ))
        db.send_create_signal('p3', ['AttendeeProfile'])


    def backwards(self, orm):
        
        # Deleting model 'AttendeeProfile'
        db.delete_table('p3_attendeeprofile')
    ...
    models = {
        ...
        'p3.attendeeprofile': {
            ...
            'diet': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'python_experience': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'shirt_size': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
